namespace Bombones2025Semi.Windows
{
    partial class frmChocolate
    {
        ...
        private void InitializeComponent()
        {
            ...
            pnldgvDatos = new Panel();
            dgvDatos = new DataGridView();
            colNombre = new DataGridViewTextBoxColumn();
            colId = new DataGridViewTextBoxColumn();
            toolStrip1.SuspendLayout();
            pnldgvDatos.SuspendLayout();
            ...
            // pnldgvDatos
            // 
            pnldgvDatos.Controls.Add(dgvDatos);
            pnldgvDatos.Dock = DockStyle.Fill;
            pnldgvDatos.Location = new Point(0, 72);
            pnldgvDatos.Name = "pnldgvDatos";
            pnldgvDatos.Size = new Size(800, 332);
            pnldgvDatos.TabIndex = 1;
            // 
            // dgvDatos
            // 
            ...
            dgvDatos.Columns.AddRange(new DataGridViewColumn[] { colNombre, colId });
            dgvDatos.Dock = DockStyle.Fill;
            dgvDatos.Location = new Point(0, 0);
            dgvDatos.Name = "dgvDatos";
            dgvDatos.Size = new Size(800, 332);
            dgvDatos.TabIndex = 0;
            // 
            // colNombre
            // 
            ...
            pnldgvDatos.ResumeLayout(false);
